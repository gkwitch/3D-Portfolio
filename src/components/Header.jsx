    ...
    return (
        <header className="absolute w-full z-50 transition-all duration-300">
            <nav className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
                ...
                >
                    <div className="h-10 w-10 rounded-xl bg-linear-to-r from-gray-500 to-gray-100 flex items-center 
                ...
                <div className="md:flex hidden items-center space-x-4">
                    <motion.a 
                        ...
                        className="text-gray-700 dark:text-gray-300 hover:text-violet-700 dark:hover:text-violet-400 
                ...
                {/* Hire me Button (Escondido no mobile para não quebrar o layout da navbar) */}
                <div className="hidden md:block">
                    <motion.button 
                        ...
                        className="ml-4 px-4 py-2.5 rounded-xl bg-gradient-to-r from-gray-400 to-gray-100 text-violet-700 font-bold hover:from-violet-700 hover:to-purple-700 hover:text-[#F0F0F0] transition-all duration-500"
                    >
                        Hire Me
                    </motion.button>
                </div>
            ...
            >
                {/* Movi o padding (px-4 py-5) para cá para não ficar aparente quando fechado */}
                <nav className="flex flex-col space-y-3 px-4 py-5">
                    {["Home", "About", "Projects", "Experience", "Contact"].map((item) => (
                        <a 
                            onClick={toggleMenu} 
                            className="text-gray-800 dark:text-gray-300 font-medium py-2 hover:text-violet-600 
                            transition-colors"
                            key={item}
                            href="#"
                        >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                className="mt-4 block w-full px-4 py-2 rounded-lg bg-gradient-to-r from-violet-600 to-violet-400
                font-bold">
                    Contact Me
                </button>
            </div>
            ...
            <AnimatePresence>
                {contactFormOpen && (
                    ...
                    <form className="space-y-4">
                        ...
                        whileTap={{scale: 0.97}}
                        className="w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700
                        hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg
